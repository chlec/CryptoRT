...
module.exports = function(socket) {
	...
	let provider = getCookie(cookies, 'provider')
	let API = provider === 'polo'
				? new Polo(getCookie(cookies, 'api'), getCookie(cookies, 'secret'))
				: new Bittrex(getCookie(cookies, 'api'), getCookie(cookies, 'secret'))
